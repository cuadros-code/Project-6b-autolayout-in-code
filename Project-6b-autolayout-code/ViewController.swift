...
//  Project-6b-autolayout-code
//
//  Created by Kevin Cuadros on 10/08/24.
//
...
//            label.trailingAnchor.constraint(equalTo: label.trailingAnchor).isActive = true
            ...
            if let previous = previous {
                ...
                label.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 0.1).isActive = true
            }
